...
function buildPool({ diet, styles, quickOnly, glutenFree, seasonal, month, excluded, original, frozenOk }) {
  ...
  const layers = [
    [dietTest, exoticTest, styleTest, quickTest, glutenTest, seasonTest],
    [dietTest, exoticTest, styleTest, quickTest, glutenTest],
    [dietTest, exoticTest, styleTest, quickTest],
...
function generateWeek({ budget, people, dinners, lunches, diet, styles, quickOnly, glutenFree, seasonal, month, store, batchCooking, excluded, lockedItems, original, frozenOk, econMode }) {
  ...
  const rawPool = buildPool({ diet, styles, quickOnly, glutenFree, seasonal, month, excluded, original, frozenOk });
