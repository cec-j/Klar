...
const RECIPES = [
  ...
  { id: 36, name: "Poulet crémeux tomates séchées (façon Marry Me Chicken)", tags: ["viande"], style: ["gourmand", "proteine"], base: "Blancs de poulet", diff: "moyen", gluten: false, time: 30,
    ing: [
      { n: "Blancs de poulet", q: 350, u: "g", c: "Viande & poisson", p: 4.20 },
      { n: "Crème fraîche", q: 20, u: "cl", c: "Crèmerie", p: 0.90 },
  ...
  { id: 38, name: "Bowl cottage cheese, fruits rouges et granola", tags: ["vegetarien", "rapide"], style: ["healthy", "proteine"], base: "Cottage cheese", diff: "facile", gluten: true, time: 5,
    ing: [
  ...
  { id: 39, name: "Toast avocat, œuf poché, dukkah", tags: ["vegetarien", "rapide"], style: ["healthy", "anti-inflammatoire"], base: "Avocat", diff: "facile", gluten: true, time: 15,
    ing: [
  ...
  { id: 40, name: "Crispy rice salad façon TikTok, saumon fumé", tags: ["poisson", "rapide"], style: ["gourmand", "proteine"], base: "Riz", diff: "moyen", gluten: true, time: 20,
    ing: [
  ...
  { id: 41, name: "Salmon bowl façon TikTok, riz, concombre, sriracha", tags: ["poisson", "rapide"], style: ["gourmand", "proteine", "anti-inflammatoire"], base: "Pavés de saumon", diff: "facile", gluten: true, time: 20,
    ing: [
  ...
  { id: 43, name: "Riz frit façon kimchi, œuf au plat", tags: ["vegetarien", "rapide"], style: ["gourmand", "anti-inflammatoire"], base: "Riz", diff: "facile", gluten: true, time: 20,
    ing: [
  ...
  { id: 48, name: "Nouilles gochujang épicées au poulet", tags: ["viande", "rapide"], style: ["gourmand", "proteine"], base: "Blancs de poulet", diff: "facile", gluten: true, time: 20,
    ing: [
      { n: "Blancs de poulet", q: 300, u: "g", c: "Viande & poisson", p: 3.60 },
      { n: "Nouilles chinoises", q: 200, u: "g", c: "Féculents & épicerie", p: 1.00 },
  ...
  { id: 49, name: "Saumon laqué au miso", tags: ["poisson", "rapide"], style: ["gourmand", "proteine", "anti-inflammatoire"], base: "Pavés de saumon", diff: "facile", gluten: true, time: 20,
    ing: [
      { n: "Pavés de saumon", q: 2, u: "pièce", c: "Viande & poisson", p: 5.50 },
  ...
  { id: 51, name: "Tuna sushi bake (façon California roll gratiné)", tags: ["poisson"], style: ["gourmand", "proteine"], base: "Thon en boîte", diff: "facile", gluten: false, time: 35,
    ing: [
  ...
  { id: 54, name: "Falafels maison, sauce tahini", tags: ["vegetarien", "rapide"], style: ["healthy", "proteine", "anti-inflammatoire"], base: "Pois chiches", diff: "facile", gluten: true, time: 20,
    ing: [
  ...
  { id: 58, name: "Bibimbap simplifié, bœuf", tags: ["viande"], style: ["proteine"], base: "Bœuf haché", diff: "moyen", gluten: true, time: 30,
    ing: [
      { n: "Bœuf haché", q: 300, u: "g", c: "Viande & poisson", p: 3.60 },
      { n: "Riz", q: 250, u: "g", c: "Féculents & épicerie", p: 0.65 },
      { n: "Carottes", q: 150, u: "g", c: "Fruits & légumes", p: 0.30 },
  ...
  { id: 59, name: "Tofu croustillant, sauce cacahuète", tags: ["vegetarien", "rapide"], style: ["healthy", "proteine", "anti-inflammatoire"], base: "Tofu", diff: "facile", gluten: false, time: 20,
    ing: [
  ...
  { id: 60, name: "Curry vert thaï, légumes", tags: ["vegetarien", "rapide"], style: ["healthy", "anti-inflammatoire"], base: "Lait de coco", diff: "facile", gluten: false, time: 20,
    ing: [
  ...
  { id: 61, name: "Soupe miso, saumon, nouilles udon", tags: ["poisson", "rapide"], style: ["healthy", "proteine", "anti-inflammatoire"], base: "Pavés de saumon", diff: "facile", gluten: true, time: 20,
    ing: [
  ...
  { id: 65, name: "Riz de chou-fleur bowl teriyaki, poulet", tags: ["viande", "rapide"], style: ["healthy", "proteine"], base: "Blancs de poulet", diff: "facile", gluten: true, time: 20,
    ing: [
      { n: "Blancs de poulet", q: 300, u: "g", c: "Viande & poisson", p: 3.60 },
  ...
  { id: 66, name: "Nouilles udon, sauce cacahuète, tofu", tags: ["vegetarien", "rapide"], style: ["healthy", "proteine"], base: "Tofu", diff: "facile", gluten: true, time: 20,
    ing: [
  ...
  { id: 68, name: "Bowl teriyaki, tofu croustillant", tags: ["vegetarien", "rapide"], style: ["healthy", "proteine"], base: "Tofu", diff: "facile", gluten: true, time: 20,
    ing: [
      { n: "Tofu ferme", q: 400, u: "g", c: "Féculents & épicerie", p: 2.80 },
      { n: "Riz", q: 200, u: "g", c: "Féculents & épicerie", p: 0.50 },
      { n: "Sauce teriyaki", q: 1, u: "sachet", c: "Féculents & épicerie", p: 0.80 },
  ...
  { id: 69, name: "Curry rouge de crevettes, riz", tags: ["poisson", "rapide"], style: ["gourmand", "proteine", "anti-inflammatoire"], base: "Crevettes", diff: "facile", gluten: false, time: 20,
    ing: [
  ...
  { id: 70, name: "Poke bowl thon épicé, riz vinaigré", tags: ["poisson", "rapide"], style: ["healthy", "proteine", "anti-inflammatoire"], base: "Thon en boîte", diff: "facile", gluten: false, time: 15,
    ing: [
      { n: "Thon en boîte", q: 2, u: "boîte", c: "Viande & poisson", p: 2.60 },
      { n: "Riz", q: 200, u: "g", c: "Féculents & épicerie", p: 0.50 },
      { n: "Avocat", q: 1, u: "pièce", c: "Fruits & légumes", p: 1.20 },
  ...
  { id: 75, name: "Halloumi grillé, salade pastèque", tags: ["vegetarien", "rapide"], style: ["healthy", "gourmand"], base: "Halloumi", diff: "facile", gluten: false, time: 15,
    ing: [
  ...
  { id: 76, name: "Bowl saumon teriyaki, riz vapeur", tags: ["poisson", "rapide"], style: ["gourmand", "proteine", "anti-inflammatoire"], base: "Pavés de saumon", diff: "facile", gluten: true, time: 20,
    ing: [
      { n: "Pavés de saumon", q: 2, u: "pièce", c: "Viande & poisson", p: 5.50 },
      { n: "Riz", q: 200, u: "g", c: "Féculents & épicerie", p: 0.50 },
      { n: "Sauce teriyaki", q: 1, u: "sachet", c: "Féculents & épicerie", p: 0.80 },
  ...
  { id: 77, name: "Curry de légumes rouge (thaï), tofu", tags: ["vegetarien"], style: ["healthy", "anti-inflammatoire"], base: "Tofu", diff: "facile", gluten: false, time: 25,
    ing: [
      { n: "Tofu ferme", q: 300, u: "g", c: "Féculents & épicerie", p: 2.10 },
      { n: "Lait de coco", q: 400, u: "ml", c: "Féculents & épicerie", p: 2.00 },
      { n: "Pâte de curry rouge", q: 1, u: "sachet", c: "Féculents & épicerie", p: 1.20 },
  ...
  { id: 78, name: "Wrap poulet façon buffalo", tags: ["viande", "rapide"], style: ["gourmand", "proteine"], base: "Blancs de poulet", diff: "facile", gluten: true, time: 20,
    ing: [
      { n: "Blancs de poulet", q: 300, u: "g", c: "Viande & poisson", p: 3.60 },
      { n: "Tortillas", q: 4, u: "pièce", c: "Féculents & épicerie", p: 1.20 },
  ...
  { id: 83, name: "Dinde façon teriyaki, riz vapeur", tags: ["viande", "rapide"], style: ["healthy", "proteine"], base: "Blancs de dinde", diff: "facile", gluten: true, time: 20,
    ing: [
...
function nutriPer100g(name, cat) {
  ...
  if (/parmesan|gruyère|comté/.test(n)) return { kcal: 380, protein: 30 };
  ...
  if (/pâtes|nouilles|orzo|gnocchis|lasagnes|riz|tortillas|pain|frites|pomme|corn flakes|semoule|vermicelles|chapelure/.test(n)) return { kcal: 300, protein: 8 };
...
function buildPool({ diet, styles, quickOnly, glutenFree, seasonal, month, excluded }) {
...
function generateWeek({ budget, people, dinners, lunches, diet, styles, quickOnly, glutenFree, seasonal, month, store, batchCooking, excluded, lockedItems }) {
  ...
  const rawPool = buildPool({ diet, styles, quickOnly, glutenFree, seasonal, month, excluded });
  const pool = rawPool.filter((r) => !lockedIds.has(r.id));

  const { chosen: freshChosen, total: freshTotal } = batchCooking
    ? selectBatch(pool, remainingDinners, remainingLunches, remainingBudget, costOf)
    : selectSingles(pool, remainingDinners, remainingLunches, remainingBudget, costOf);

  const chosen = [...lockedChosen, ...freshChosen];
  const total = lockedTotal + freshTotal;
  ...
  return { chosen, total, shopping, colorMap, pairedBases, batchCooking, poolEmpty: rawPool.length === 0 };
}
...
function buildShoppingText(result, store, people, dinners, lunches, checked) {
  if (!result) return "";
  const lines = [];
  lines.push("L'ARDOISE — Liste de courses");
...
export default function App() {
  ...
  const runGenerate = useCallback(() => {
    ...
    const r = generateWeek({ budget, people, dinners, lunches, diet, styles, quickOnly, glutenFree, seasonal, month, store, batchCooking, excluded, lockedItems });
    setResult(r);
    setChecked((prev) => {
  ...
  }, [budget, people, dinners, lunches, diet, styles, quickOnly, glutenFree, seasonal, month, store, batchCooking, excluded, lockedItems, totalMeals]);
  ...
  const copyShoppingList = async () => {
    ...
    try {
      ...
      downloadTextFile("ardoise-liste-de-courses.txt", text);
    }
  };

  const downloadShoppingList = () => {
    downloadTextFile("ardoise-liste-de-courses.txt", buildShoppingText(result, store, people, dinners, lunches, checked));
  };
  ...
  const downloadMenuImage = async () => {
    ...
    ctx.fillText("L'ARDOISE", width / 2, pad + 44);
    ...
    const a = document.createElement("a");
    a.href = dataUrl;
    a.download = "ardoise-menu-semaine.png";
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
  };
      ...
      <div className="max-w-5xl mx-auto px-5 py-10">
        ...
        <header className="mb-8">
          ...
          <p className="mt-2 text-sm max-w-xl" style={{ opacity: 0.75 }}>
            Choisis ton budget, ton magasin, tes envies — l'appli compose ta semaine de repas et la liste de
            courses qui va avec. Gratuit, sans compte, sans surprise à la fin.
          </p>
        </header>
              ...
              <div>
                ...
                >
                  <div className="text-center mb-4">
                    <div className="font-bold text-lg tracking-widest">L'ARDOISE</div>
